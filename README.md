...
treatment $a=0, 1$. We are interested in marginal effects, which are
causal effects of the form $r(\Psi_1, \Psi_0)$. The package uses plug-in
estimation for robust estimation of a marginal effect estimand and (CV)
influence functions for robust estimation of the variance of the
estimand (Rosenblum, M. and M. J. van der Laan, 2010: Simple, efficient
