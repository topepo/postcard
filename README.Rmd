...
Functionalities available include functions `variance_ancova`, `power_gs`, `samplesize_gs`, `power_nc`. 

### For generalized linear models

The functionalities assume a linear model, whereas the function `power_glm` can be used for generalized linear models.
